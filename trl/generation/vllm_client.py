...
class VLLMClient:
    ...
    def update_model_params(self, model: nn.Module, chunk_size: int | None = None):
        """
        Updates all parameters of the given model using batch update to reduce HTTP round-trips.
